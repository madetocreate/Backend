...
export function buildGlobalInstructions(): string {
  return [
    ...
    "  - code_interpreter (or similar analysis tools): to analyse tables, data and documents.",
    "",
    "Rules:",
    "",
    "- Choose a specialized agent or tool when it clearly improves the answer:",
    "  - complex data or tables -> use analysis tools / code interpreter.",
...
export function buildRuntimeInstructions(input: OrchestratorInput): string {
  ...
  const lines: string[] = [
    ...
    "",
    "If mode = \"analysis\":",
    "- Use tools such as file_search or code_interpreter when appropriate.",
