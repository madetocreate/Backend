...
import { z } from "zod";
import { createBlueprintForKasten } from "../domain/wunschkasten/blueprintService";
...
export async function registerWunschkastenBlueprintRoutes(
  app: FastifyInstance
): Promise<void> {
  app.post("/agent/wunschkasten/blueprint", async (request, reply) => {
